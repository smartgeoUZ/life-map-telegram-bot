...
public class Commands {
    ...
    public static final String ADD_EVENT_COMMAND = commandInitChar + "addevent";
    public static final String SET_LANGUAGE_COMMAND = commandInitChar +  "setlanguage";
    public static final String SUPPORT_COMMAND = commandInitChar + "support";
